...
程式檔案名稱：1. hw5.java  2. player.java  3. windCard.java  4. waterCard.java  5. thunderCard.java  6. solidCard.java  
...
程式剛開始執行要先輸入雙方玩家姓名和職業 [player1_name][ player1 的職業名稱][player2_name] [ player2 的職業名稱] (ex: Mike Warrior John Magician) ，接著由玩家一先開始
...
5.輸入cast ability [怪獸的位置或玩家] (ex:cast ability myself, cast ability enemy , cast ability U6)，可以施放職業技能
6.輸入finish，結束當前玩家之回合
7.輸入exit，可以結束系統
